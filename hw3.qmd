...
Also, when I realizd that there is a coding window that pops up and shows what I've voded, I just showed that instead of rewriting my code on the whole thing. And it also shows the answers, so I also stopped rewriting the answers down since it's already there. It makes it look more clean and easier to read. 
